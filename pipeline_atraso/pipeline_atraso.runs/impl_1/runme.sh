...
HD_PWD='C:/Users/aluno/Desktop/gitapagar/SATD-research/pipeline_atraso/pipeline_atraso.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log multiplicador.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source multiplicador.tcl -notrace
