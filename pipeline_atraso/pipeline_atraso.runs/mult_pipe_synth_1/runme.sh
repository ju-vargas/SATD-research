...
HD_PWD='C:/Users/aluno/Desktop/gitapagar/SATD-research/pipeline_atraso/pipeline_atraso.runs/mult_pipe_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mult_pipe.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mult_pipe.tcl
