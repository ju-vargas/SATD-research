...
HD_PWD='C:/Users/aluno/Desktop/gitapagar/SATD-research/pipeline_atraso/pipeline_atraso.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log multiplicador.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source multiplicador.tcl
